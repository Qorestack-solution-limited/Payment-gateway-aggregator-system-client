...
export function CTABanner() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(135deg, #0B2518 0%, #1A4A2E 60%, #0d3020 100%)" }}
      ref={ref}>
      <div
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
          ...
          <div
            ...
            style={{ background: "rgba(200, 240, 74, 0.12)", border: "1px solid rgba(200, 240, 74, 0.25)", color: "#C8F04A" }}>
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white mb-6">
            Ready to Unify
            <br />
            <span style={{ color: "#C8F04A" }}>Your Payments?</span>
          </h2>

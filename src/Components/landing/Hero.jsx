...
function CreditCard() {
  return (
    <div
      ...
      style={{ height: "280px", maxWidth: "360px" }}
    >
      <div
      ...
      >
        <div className="p-5 h-full flex flex-col justify-between opacity-70">
          ...
          <div>
            <div className="text-white/40 text-xs mb-1">.... .... .... 1289</div>
          </div>
        </div>
      </div>
...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-5 text-black bg-green-950" />
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <span className="block mt-1">
                ...
                <span style={{ color: "#C8F04A" }}>Business.</span>
              </span>
            </motion.h1>
            ...
            <motion.p
              ...
              style={{ color: "rgba(23, 22, 22, 0.65)" }}
            >
            ...
            >
              ...
              >
                <CheckCircleIcon className="w-4 h-4" style={{ color: "#C8F04A" }} />
            ...
            >
              <div className="flex -space-x-2">
                {["#C8F04A", "#34d399", "#60a5fa", "#f472b6"].map((color, index) => (
                  <div
                    key={color}
